...
type CalculateResponse struct {
	...
	Error         string                 `protobuf:"bytes,2,opt,name=error,proto3" json:"error,omitempty"` // 如果有错误，例如除以零
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_calculator_proto_rawDesc = "" +
	...
	"\rsecond_number\x18\x02 \x01(\x01R\fsecondNumber\x12\x1a\n" +
	...
	"\tCalculate\x12\x1c.calculator.CalculateRequest\x1a\x1d.calculator.CalculateResponseB\x1aZ\x18calculator/api/proto/genb\x06proto3"
