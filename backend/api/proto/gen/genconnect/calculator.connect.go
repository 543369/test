...
type CalculatorServiceClient interface {
	// 执行计算操作
	Calculate(context.Context, *connect_go.Request[gen.CalculateRequest]) (*connect_go.Response[gen.CalculateResponse], error)
}
...
func NewCalculatorServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) CalculatorServiceClient {
	...
	return &calculatorServiceClient{
		calculate: connect_go.NewClient[gen.CalculateRequest, gen.CalculateResponse](
			httpClient,
...
type calculatorServiceClient struct {
	calculate *connect_go.Client[gen.CalculateRequest, gen.CalculateResponse]
}

// Calculate calls calculator.CalculatorService.Calculate.
func (c *calculatorServiceClient) Calculate(ctx context.Context, req *connect_go.Request[gen.CalculateRequest]) (*connect_go.Response[gen.CalculateResponse], error) {
...
func (UnimplementedCalculatorServiceHandler) Calculate(context.Context, *connect_go.Request[gen.CalculateRequest]) (*connect_go.Response[gen.CalculateResponse], error) {
