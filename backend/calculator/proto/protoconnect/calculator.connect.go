...
type CalculatorServiceClient interface {
	// 执行计算操作
	Calculate(context.Context, *connect_go.Request[proto.CalculateRequest]) (*connect_go.Response[proto.CalculateResponse], error)
}
...
func NewCalculatorServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) CalculatorServiceClient {
	...
	return &calculatorServiceClient{
		calculate: connect_go.NewClient[proto.CalculateRequest, proto.CalculateResponse](
			httpClient,
...
type calculatorServiceClient struct {
	calculate *connect_go.Client[proto.CalculateRequest, proto.CalculateResponse]
}

// Calculate calls calculator.CalculatorService.Calculate.
func (c *calculatorServiceClient) Calculate(ctx context.Context, req *connect_go.Request[proto.CalculateRequest]) (*connect_go.Response[proto.CalculateResponse], error) {
...
func (UnimplementedCalculatorServiceHandler) Calculate(context.Context, *connect_go.Request[proto.CalculateRequest]) (*connect_go.Response[proto.CalculateResponse], error) {
